---
title: "Quickstart"
description: "How to install Accountant24 with Homebrew, connect an LLM provider (OpenAI, Anthropic, or local Ollama), and log your first transaction in five minutes."
---
