...
See the [Use Cases](/docs/use-cases) for examples, the [Quickstart](/docs/quickstart) to install it, or the [Comparison](/docs/comparison) for how it stacks up against YNAB, Monarch, and Actual Budget.

<img
  src="/images/desktop-app-2.png"
  alt="Accountant24 — desktop app"
  style={{ width: "100%", borderRadius: 8, marginTop: 8 }}
/>

<p align="center">
  <a href="https://github.com/machulav/accountant24/releases/latest/download/Accountant24.dmg">
