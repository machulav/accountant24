...
description: "Accountant24 is a free, local-first AI agent for personal finance. Track spending in plain language, import bank statements and receipts, ask questions about your money. Your data stays as plain text files on your machine. Works with any LLM, including local ones. All changes are versioned with git."
---

Accountant24 is a free, local-first AI agent for personal finance. Track spending in plain language, import bank statements and receipts, ask questions about your money. Your data stays as plain text files on your machine. Works with any LLM, including local ones. All changes are versioned with git.
