...
A plugin is a small package of skills. A skill is a reusable playbook the agent follows, like a monthly review or a subscription audit. See [Plugins](/plugins) for more details.
...
Put your plugin in a public GitHub repository and add the topic `accountant24-plugin`. It appears at the next refresh. See the [Create a plugin](/create-a-plugin) page for more details.
