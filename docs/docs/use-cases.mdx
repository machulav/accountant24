...
Skills are reusable playbooks the agent follows step by step, like monthly reviews or subscription audits. Use the built-in ones or create your own. See [Skills](/docs/skills) for details.
