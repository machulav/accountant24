...
Skills are reusable playbooks the agent follows step by step, like monthly reviews or subscription audits. Install them from the [plugin marketplace](/docs/marketplace) or [create your own](/docs/create-a-plugin).
