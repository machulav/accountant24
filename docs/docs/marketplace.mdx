...
description: "The marketplace lists plugins published by other people."
---

The marketplace lives in **Settings → Plugins**, where you can browse and install plugins without leaving the app.

A plugin is a small package of skills. A skill is a reusable playbook the agent follows, like a monthly review or a subscription audit. See [Plugins](/docs/plugins) for how they work.
