...
The plugin appears in the [marketplace](/marketplace) at the next refresh, within about 30 minutes. Anyone can then install it from **Settings → Plugins**.
...
4. It records the source repository in [app-settings.json](/settings#plugins).
