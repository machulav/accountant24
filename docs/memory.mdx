...
Memory is stored in `memory.md` in your [workspace](/workspace), a plain markdown file you can open and edit by hand. Like your ledger, every change to it is versioned with git.
