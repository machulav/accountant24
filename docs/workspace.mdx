...
| `memory.md`         | The agent's [memory](/memory)                                      | Yes                |
| `plugins/`          | Your installed [plugins](/plugins)                                 | Yes                |
| `app-settings.json` | The [app settings](/settings)                                      | Yes                |
...
| `uv/`              | Python and packages for [plugin scripts](/create-a-plugin#helper-scripts), downloaded on first use and safe to delete | No                 |
