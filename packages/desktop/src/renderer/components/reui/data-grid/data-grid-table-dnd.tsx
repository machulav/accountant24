...
function DataGridTableDndCell<TData extends object>({ cell }: { cell: Cell<DataGridFeatures, TData, unknown> }) {
  const { props } = useDataGrid();
  ...
  return (
    ...
    >
      <DataGridTableViewport
        ...
        className={isDraggingColumn ? "relative cursor-grabbing [&_*]:cursor-grabbing!" : "relative"}
      >
        <DataGridTableBase>
          <DataGridTableHead>
