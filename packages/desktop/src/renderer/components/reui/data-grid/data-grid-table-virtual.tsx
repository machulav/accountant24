...
function DataGridTableVirtualUtilityRow<TData extends object>({
  ...
  return (
    <tr aria-hidden={ariaHidden || undefined} className={rowClassName}>
      ...
      <td colSpan={Math.max(centerVisibleColumns.length, 1)} className={centerCellClassName} style={centerCellStyle}>
        {children}
      </td>
...
function DataGridTableVirtual<TData extends object>({
  ...
  const usesExternalScrollArea =
    viewportElements.scrollElement !== null && viewportElements.scrollElement !== viewportElements.containerElement;
