...
//
// `scripts/build.ts` bundles this into a single self-contained `accountant24-extension.js`
// (externalizing pi's virtual modules), which the desktop app loads via `pi -e <path>`.
